...
for x in range(10):
    colors.append((0,0,0))
for i in range(15):
    colors.append((float_gen(.1, 1), float_gen(.1, .8), float_gen(.1, 1)))
    colors.append((0, 0, 0))
...
def main():
    ...
    parser.add_argument("-d", "--deviation", default=1500, type=int)
    ...
    parser.add_argument("-maxs", "--maxshapes", default=10, type=int)
    parser.add_argument("-sa", "--shapealpha", default=.0085, type=float)
